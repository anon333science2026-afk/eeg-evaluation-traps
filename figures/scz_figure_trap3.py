#!/usr/bin/env python3
"""
SCZ vs C — Trap 3: Epoch vs Subject accuracy scatter.
...
Dataset: SCZ vs Control
  ...
  Epoch-level chance: 0.500 (perfectly balanced)
  Subject-level chance: 0.500 (perfectly balanced)
"""
...
CHANCE_SUBJ  = 0.500   # balanced 14/14 at subject level
...
outfile = OUT_DIR / "scz_trap3_epoch_vs_subject_P6_P2.png"
