#!/usr/bin/env python3
"""
AD vs C — Trap 3: Epoch vs Subject accuracy scatter.
Random-50 only: P=6 (circles) and P=2 (triangles).
Horizontal 1x2: PCA (left), T-test (right).

Dataset: AD vs Control
  AD: 36 subjects / Control: 29 subjects / Total: 65
  Epoch-level chance: 18607/34044 = 0.547
  Subject-level chance: 36/65 = 0.554
...
IN_CSV  = Path(f"{REPO}/processed_data/results/ad/ad_fold_epoch_vs_subject.csv")
OUT_DIR = Path(f"{REPO}/figures/out")

CHANCE_EPOCH = 18607 / 34044   # 0.547 — epoch-level majority class
CHANCE_SUBJ  = 36 / 65         # 0.554 — subject-level majority class
...
outfile = OUT_DIR / "ad_trap3_epoch_vs_subject_P6_P2.png"
