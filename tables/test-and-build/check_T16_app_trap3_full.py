...
# Data sources
SOURCE = {
    "AD":     dict(comb=ROOT/"data/results/ad/ad_all_experiments_combined.csv",
                   fold=ROOT/"data/results/ad/ad_fold_epoch_vs_subject.csv",
                   pcol="pipeline", cond=None,
                   exp={"T-test":{6:"ANOVA_L_6_Random",2:"ANOVA_L_2_Random"},
                        "PCA":   {6:"PCA_L_6_Random",  2:"PCA_L_2_Random"}}),
    "FTD":    dict(comb=ROOT/"data/results/ftd/ftd_all_experiments_combined.csv",
                   fold=ROOT/"data/results/ftd/ftd_fold_epoch_vs_subject.csv",
                   pcol="pipeline", cond=None,
                   exp={"T-test":{6:"ANOVA_L_6_FTD",2:"ANOVA_L_2_FTD"},
                        "PCA":   {6:"PCA_L_6_FTD",  2:"PCA_L_2_FTD"}}),
    "MDD EC": dict(comb=ROOT/"data/results/mdd/mdd_all_experiments_combined.csv",
                   fold=ROOT/"data/results/mdd/mdd_fold_epoch_vs_subject.csv",
                   pcol="feature_set", cond="EC",
                   exp={"T-test":{6:"ANOVA_L_6_EC",2:"ANOVA_L_2_EC"},
                        "PCA":   {6:"PCA_L_6_EC",  2:"PCA_L_2_EC"}}),
    "MDD EO": dict(comb=ROOT/"data/results/mdd/mdd_all_experiments_combined.csv",
                   fold=ROOT/"data/results/mdd/mdd_fold_epoch_vs_subject.csv",
                   pcol="feature_set", cond="EO",
                   exp={"T-test":{6:"ANOVA_L_6_EO",2:"ANOVA_L_2_EO"},
                        "PCA":   {6:"PCA_L_6_EO",  2:"PCA_L_2_EO"}}),
    "SCZ":    dict(comb=ROOT/"data/results/scz/scz_all_experiments_combined.csv",
                   fold=ROOT/"data/results/scz/scz_fold_epoch_vs_subject.csv",
                   pcol="pipeline", cond=None,
